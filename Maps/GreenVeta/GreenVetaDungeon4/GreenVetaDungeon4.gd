...
var pos_on_map = {
	...
	"stage_3_start_pos": Vector2(2316,1938),
	"stage_4_start_pos": Vector2(4826,2300),
	"back_to_stage_1_pos": Vector2(720,150),
	"back_to_stage_2_pos": Vector2(2312,424),
	"back_to_stage_3_pos": Vector2(2678,2208)
}
...
var map_name = "GREENVETA DUNGEON 4"
