...
var pos_on_map = {
	...
	"stage_2_start_pos": Vector2(306,2188),
	"stage_3_start_pos": Vector2(2974,2442),
	"stage_4_start_pos": Vector2(6464,2400),
	"back_to_stage_1_pos": Vector2(320,382),
	"back_to_stage_2_pos": Vector2(698,2420),
	"back_to_stage_3_pos": Vector2(3676,2450)
}
...
var map_name = "GREENVETA DUNGEON 3"
