...
var pos_on_map = {
	...
	"stage_3_start_pos": Vector2(3800,175),
	"stage_4_start_pos": Vector2(5900,180),
	"back_to_stage_1_pos": Vector2(720,150),
	"back_to_stage_2_pos": Vector2(2700,162),
	"back_to_stage_3_pos": Vector2(4500,170)
}
...
var map_name = "GREENVETA DUNGEON 1"
