...
var pos_on_map = {
	"stage_1_start_pos": Vector2(624,102),
	"stage_2_start_pos": Vector2(-1898,128),
	"stage_3_start_pos": Vector2(-2344,2024),
	"stage_4_start_pos": Vector2(-4722,2380),
	"back_to_stage_1_pos": Vector2(-128,176),
	"back_to_stage_2_pos": Vector2(-2274,372),
	"back_to_stage_3_pos": Vector2(-2710,2290)
}
...
var map_name = "GREENVETA DUNGEON 5"
